...
export type CheckQualityEntity = {
  ...
  createdAt: Scalars['DateTime']['output'];
  failedEvaluationCriteria?: Maybe<Array<CheckQualityFailedEvaluationCriteriaEntity>>;
...
export type CheckQualityFailedEvaluationCriteriaEntity = {
  __typename?: 'CheckQualityFailedEvaluationCriteriaEntity';
  checkQualityId: Scalars['ID']['output'];
  createdAt: Scalars['DateTime']['output'];
...
export type DoneCheckQualityInput = {
  ...
  failedEvaluationCriteriaIds?: InputMaybe<Array<Scalars['String']['input']>>;
...
export type OrderEntity = {
  ...
  expectedReceiveAt?: Maybe<Scalars['DateTime']['output']>;
  factory?: Maybe<FactoryEntity>;
  factoryId?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
...
export type OrderEvaluationCriteriaQueryVariables = Exact<{
  productId: Scalars['ID']['input'];
}>;


export type OrderEvaluationCriteriaQuery = { __typename?: 'Query', evaluationCriteriaByProduct: Array<{ __typename?: 'EvaluationCriteriaEntity', createdAt: any, description?: string | null, id: string, isActive: boolean, isDeleted: boolean, name: string, updatedAt?: any | null }>, systemConfigOrder: { __typename?: 'SystemConfigOrderEntity', maxEvaluationCriteria: number } };
...
export const OrderEvaluationCriteriaDocument = gql`
...
/**
 * __useOrderEvaluationCriteriaQuery__
 *
 * To run a query within a React component, call `useOrderEvaluationCriteriaQuery` and pass it any options that fit your needs.
 * When your component renders, `useOrderEvaluationCriteriaQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOrderEvaluationCriteriaQuery({
 *   variables: {
 *      productId: // value for 'productId'
 *   },
 * });
 */
export function useOrderEvaluationCriteriaQuery(baseOptions: Apollo.QueryHookOptions<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables> & ({ variables: OrderEvaluationCriteriaQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>(OrderEvaluationCriteriaDocument, options);
      }
export function useOrderEvaluationCriteriaLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>(OrderEvaluationCriteriaDocument, options);
        }
export function useOrderEvaluationCriteriaSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>(OrderEvaluationCriteriaDocument, options);
        }
export type OrderEvaluationCriteriaQueryHookResult = ReturnType<typeof useOrderEvaluationCriteriaQuery>;
export type OrderEvaluationCriteriaLazyQueryHookResult = ReturnType<typeof useOrderEvaluationCriteriaLazyQuery>;
export type OrderEvaluationCriteriaSuspenseQueryHookResult = ReturnType<typeof useOrderEvaluationCriteriaSuspenseQuery>;
export type OrderEvaluationCriteriaQueryResult = Apollo.QueryResult<OrderEvaluationCriteriaQuery, OrderEvaluationCriteriaQueryVariables>;
