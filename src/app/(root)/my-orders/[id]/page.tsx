...
import { ArrowLeft, Calendar, CreditCard, Loader2, Package, ShoppingBag, User, XCircle } from "lucide-react"
            ...
            <TabsContent value="transactions">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>All transactions for this order</CardDescription>
                </CardHeader>
                <CardContent>
                  {order.payments &&
                  order.payments.some((payment) => payment.transactions && payment.transactions.length > 0) ? (
                    <Table>
                      <TableHeader>
                        <TableRow>
                    ...
                    <div className="text-center py-6">
                      <CreditCard className="mx-auto h-8 w-8 text-muted-foreground mb-2" />
                      <p className="text-muted-foreground">No transaction records found</p>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatPrice(order.totalPrice - order.shippingPrice)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatPrice(order.depositPaid)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Balance Due:</span>
                  <span className="font-bold">{formatPrice(order.totalPrice - order.depositPaid)}</span>
                </div>
              </div>
            </CardContent>
            <CardFooter>
