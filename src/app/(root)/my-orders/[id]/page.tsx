...
import { ArrowLeft, Calendar, ChevronDown, ChevronRight, CreditCard, Loader2, Package, ShoppingBag, User, XCircle } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-1">Deposit Paid</h3>
                <p className="text-xl font-bold">{formatPrice(order.depositPaid)}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium text-muted-foreground mb-1">Shipping</h3>
        ...
        <Card className="text-center">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <ShoppingBag className="h-12 w-12 text-muted-foreground mb-4" />
            <h2 className="text-xl font-semibold mb-2">No Items in This Order</h2>
                            ...
                            <div className="px-4 pb-4">
                              ...
                              {payment.transactions && payment.transactions.length > 0 ? (
                                ...
                                <div className="text-center py-4 bg-muted/30 rounded-md">
                                  <p className="text-sm text-muted-foreground">No transactions found for this payment</p>
                                </div>
                              )}
                            </div>
                          )}
