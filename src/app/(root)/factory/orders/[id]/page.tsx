...
import { AlertCircle, ArrowLeft, Calendar, CheckCircle, Clock, Loader2, Package, XCircle } from "lucide-react"
          ...
          <TabsContent value="order-details" className="mt-4">
            <Card>
              ...
              <CardFooter className="border-t pt-6">
                ...
                {order.status === "ACCEPTED" && <Button variant="default">Start Production</Button>}
                {order.status === "IN_PRODUCTION" && <Button variant="default">Mark as Completed</Button>}
              </CardFooter>
            </Card>
          </TabsContent>
        </Tabs>
