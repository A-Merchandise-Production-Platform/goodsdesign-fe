...
export function CartItem({
  ...
  const existingSizes = new Set(items.map(item => item.systemConfigVariant?.size));
                ...
                <div key={item.id} className="flex items-center justify-between border-t pt-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <p className="font-medium w-14">Size: {item.systemConfigVariant?.size}</p>
                      <Popover>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-muted-foreground">
                                {formatPrice(item.systemConfigVariant?.price || 0)}
                              </span>
                            </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                      <p className="font-semibold w-24">{formatPrice(priceInfo.totalPrice)}</p>
                      {priceInfo.discountApplied && (
