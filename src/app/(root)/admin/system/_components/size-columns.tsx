import {
  ...
  useRemoveSystemConfigSizeMutation,
...
export const sizeColumns: ColumnDef<Size>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const size = row.original;
      const [removeSize] = useRemoveSystemConfigSizeMutation({
        variables: {
          removeSystemConfigSizeId: size.id,
        },
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    {size.name} size and remove its data from our servers.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
