...
export function ShirtNew({
  ...
  console.log('Received decals in ShirtNew:', {
  ...
  console.log('Textures loaded:', {
    front: frontTexture instanceof THREE.Texture,
    back: backTexture instanceof THREE.Texture,
    left: leftTexture instanceof THREE.Texture,
    right: rightTexture instanceof THREE.Texture,
  });
